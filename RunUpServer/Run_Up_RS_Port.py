# Здесь подымаем нашы порты RS


class GETSettingsUART:
    """
    Класс для получения данных запущенных серверов с USPD
    """
    http = 'http://'
    servers_settings = '/settings/uart'
    servers_settings = '/uart_settings'
...
print(GETSettingsUART('192.168.202.22').Get_Settings())
